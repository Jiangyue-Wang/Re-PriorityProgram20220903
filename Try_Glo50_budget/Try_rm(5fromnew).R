...
##remove all new
library(stringr)
newid<-c(301911, 308549, 310150, 310288, 310289)

newname<-c("Mergus merganser_3"  ,"Regulus satrapa_2"  , "Loxia curvirostra_3" ,"Junco hyemalis_2" ,"Junco hyemalis_3")
...
feature_5km_30_sp <- feature_5km_30_sp[!feature_5km_30_sp$id%in%newid,]
target_5km_30_sp <- target_5km_30_sp[!target_5km_30_sp$feature%in%newname,]
rij_5km_30_sp <- rij_5km_30_sp[!rij_5km_30_sp$species%in%newid,]
rij_5km_30_sp <- rij_5km_30_sp[rij_5km_30_sp$species%in%feature_5km_30_sp$id,]

head(feature_5km_30_sp)
feature_5km_30_sp <-feature_5km_30_sp[-1,]
head(target_5km_30_sp)
target_5km_30_sp <- target_5km_30_sp[-1,]
rij3 <-filter(rij_5km_30_sp,amount>0.01)
###initiate a problem-------------
p_5km_30_sp<-problem(x = x_5km_30 , feature = feature_5km_30_sp, cost_column = "UParea", rij = rij3) %>%         
